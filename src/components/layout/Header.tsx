      ...
      <div className="border-b border-gray-100 bg-gray-50 overflow-hidden transition-all duration-300"
        ...
        <div className="container flex h-9 items-center justify-between text-xs text-gray-500">
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link href="/about" className="hover:text-brand-600 transition-colors">Hakkımızda</Link>
            <span className="text-gray-200">|</span>
            <a href="mailto:destek@ventapremium.com.tr" className="hover:text-brand-600 transition-colors">İletişim</a>
          </div>
          <span className="md:hidden text-gray-400 text-[11px]">🔒 Güvenli Alışveriş</span>
          <div className="flex items-center gap-3 text-gray-400">
            <a href="https://www.instagram.com/ventapremiumcomtr" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-600 transition-colors"><IconInstagram /></a>
          </div>
        </div>
      </div>
